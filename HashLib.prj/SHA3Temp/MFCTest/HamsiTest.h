...
namespace MFCTest
{
    ...
    class HamsiTest : public TestBase
    {
        private:
        ...
        protected:
            ...
            virtual void CreateHash(int a_hashLenBits)
            {
                ...
                if (a_hashLenBits <= 256)
                    m_hash = new Hamsi::Hamsi256Base(a_hashLenBits/8);
                else
                    m_hash = new Hamsi::Hamsi512Base(a_hashLenBits/8);
            }
    ...
    class HamsiOrgTest : public TestBase
    {
        private:
        ...
        protected:
            ...
            virtual void CreateHash(int a_hashLenBits)
            {
                HamsiOrg::Init(&m_hashState, a_hashLenBits);
            }
