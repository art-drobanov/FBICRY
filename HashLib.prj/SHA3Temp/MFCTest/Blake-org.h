...
#undef U8TO32_BE
#ifdef _MSC_VER
#define U8TO32_BE(p) _byteswap_ulong(*(u32*)(p))
#else
#define U8TO32_BE(p) \
    (((u32)((p)[0]) << 24) | \
    ((u32)((p)[1]) << 16) | \
...
#undef U8TO64_BE
#ifdef _MSC_VER
#define U8TO64_BE(p) _byteswap_uint64(*(u64*)(p))
#else
#define U8TO64_BE(p) \
...
#undef U32TO8_BE
#ifdef _MSC_VER
#define U32TO8_BE(p, v) *(u32*)(p) = _byteswap_ulong((v))
#else
...
#undef U64TO8_BE
#ifdef _MSC_VER
 #define U64TO8_BE(p, v) *(u64*)(p) = _byteswap_uint64((v))
#else
