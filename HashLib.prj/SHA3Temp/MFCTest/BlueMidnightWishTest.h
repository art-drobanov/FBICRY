...
namespace MFCTest
{
    class BlueMidnightWishTest : public TestBase
    {
        private:
        ...
        protected:
            ...
            virtual void CreateHash(int a_hashLenBits)
            {
                ...
                if (a_hashLenBits <= 256)
                    m_bmw = new BMW::BMW32(a_hashLenBits/8);
                else
                    m_bmw = new BMW::BMW64(a_hashLenBits/8);
            }
    ...
    class BlueMidnightWishOrgTest : public TestBase
    {
        private:
        ...
        protected:
            ...
            virtual void CreateHash(int a_hashLenBits)
            {
                BMWORG::Init(&m_hashState, a_hashLenBits);
            }
