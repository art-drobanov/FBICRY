...
namespace MFCTest
{
    class EchoTest : public TestBase
    {
        private:
        ...
        protected:
            ...
            virtual void CreateHash(int a_hashLenBits)
            {
                ...
                if (a_hashLenBits <= 256)
                    m_hash = new Echo::Echo256Base(a_hashLenBits/8);
                else
                    m_hash = new Echo::Echo512Base(a_hashLenBits/8);
            }
    ...
    class EchoOrgTest : public TestBase
    {
        private:
        ...
        protected:
            ...
            virtual void CreateHash(int a_hashLenBits)
            {
                EchoOrg::Init(&m_hashState, a_hashLenBits);
            }
