...
namespace CLRTest
{
    ref class KeccakTest : TestBase
    {
        ...
        protected:
            ...
            {
                m_hash = gcnew Keccak::Keccak(a_hashLenBits / 8);
            }
    ...
    ref class KeccakCSharpTest : TestBase
    {
        private:
        ...
        protected:
            ...
            virtual void CreateHash(int a_hashLenBits) override
            {
                m_hash = HashLib::HashFactory::Crypto::SHA3::CreateKeccak(HashLib::HashSize(a_hashLenBits / 8));
            }
