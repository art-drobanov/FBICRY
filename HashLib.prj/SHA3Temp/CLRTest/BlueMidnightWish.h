...
{    
    ref class BlueMidnightWishBase ABSTRACT
    {
        ...
        public:
            ...
            void TransformBytes(array<byte>^ a_data, int a_index, int a_length)
            {
                ...
                {
                    m_processedBytes += (uint64)BlockSize();
    ...
    ref class BlueMidnightWish256Base : public BlueMidnightWishBase
    {
        ...
        protected:
            ...
            virtual array<byte>^ GetResult() OVERRIDE
            {
                ...
                array<byte>^ state = Converters::ConvertUIntsToBytes(m_state);
    ...
    ref class BlueMidnightWish512Base : public BlueMidnightWishBase
    {
        private:
            ...
            static array<uint64>^ s_initial_state_384 = 
            {
            ...
            static array<uint64>^ s_initial_state_512 = 
            {
        ...
        protected:
            ...
            virtual void TransformBlock(array<byte>^ a_data, int a_index) OVERRIDE
            {
                array<uint64>^ data64 = Converters::ConvertBytesToULongs(a_data, a_index, 128);

                uint64 p512_00 = m_state[0] ^ data64[0];
                uint64 p512_01 = m_state[1] ^ data64[1];
                uint64 p512_02 = m_state[2] ^ data64[2];
                uint64 p512_03 = m_state[3] ^ data64[3];
                uint64 p512_04 = m_state[4] ^ data64[4];
                uint64 p512_05 = m_state[5] ^ data64[5];
                uint64 p512_06 = m_state[6] ^ data64[6];
                uint64 p512_07 = m_state[7] ^ data64[7];
                uint64 p512_08 = m_state[8] ^ data64[8];
                uint64 p512_09 = m_state[9] ^ data64[9];
                uint64 p512_10 = m_state[10] ^ data64[10];
                uint64 p512_11 = m_state[11] ^ data64[11];
                uint64 p512_12 = m_state[12] ^ data64[12];
                uint64 p512_13 = m_state[13] ^ data64[13];
                uint64 p512_14 = m_state[14] ^ data64[14];
                uint64 p512_15 = m_state[15] ^ data64[15];

                uint64 td64_00 = (data64[0] << 1) | (data64[0] >> 63);
                uint64 td64_01 = (data64[1] << 2) | (data64[1] >> 62);
                uint64 td64_02 = (data64[2] << 3) | (data64[2] >> 61);
                uint64 td64_03 = (data64[3] << 4) | (data64[3] >> 60);
                uint64 td64_04 = (data64[4] << 5) | (data64[4] >> 59);
                uint64 td64_05 = (data64[5] << 6) | (data64[5] >> 58);
                uint64 td64_06 = (data64[6] << 7) | (data64[6] >> 57);
                uint64 td64_07 = (data64[7] << 8) | (data64[7] >> 56);
                uint64 td64_08 = (data64[8] << 9) | (data64[8] >> 55);
                uint64 td64_09 = (data64[9] << 10) | (data64[9] >> 54);
                uint64 td64_10 = (data64[10] << 11) | (data64[10] >> 53);
                uint64 td64_11 = (data64[11] << 12) | (data64[11] >> 52);
                uint64 td64_12 = (data64[12] << 13) | (data64[12] >> 51);
                uint64 td64_13 = (data64[13] << 14) | (data64[13] >> 50);
                uint64 td64_14 = (data64[14] << 15) | (data64[14] >> 49);
                uint64 td64_15 = (data64[15] << 16) | (data64[15] >> 48);

                uint64 t512_16 = p512_01 - p512_14;
                uint64 t512_17 = p512_15 - p512_12;
                uint64 t512_18 = p512_14 - p512_07;
                uint64 t512_19 = p512_13 - p512_06;
                uint64 t512_20 = p512_08 - p512_05;
                uint64 t512_21 = p512_08 - p512_01;

                uint64 p512_16 = (p512_05 + t512_18 + p512_10 + p512_13);
                p512_16 = ((p512_16 >> 1) ^ (p512_16 << 3) ^ ((p512_16 << 4) | (p512_16 >> 60)) ^ ((p512_16 << 37) | (p512_16 >> 27))) + m_state[1];
                uint64 p512_17 = (p512_06 - p512_08 + p512_11 + p512_14 - p512_15);
                p512_17 = ((p512_17 >> 1) ^ (p512_17 << 2) ^ ((p512_17 << 13) | (p512_17 >> 51)) ^ ((p512_17 << 43) | (p512_17 >> 21))) + m_state[2];
                uint64 p512_18 = (p512_00 + p512_07 + p512_09 + t512_17);
                p512_18 = ((p512_18 >> 2) ^ (p512_18 << 1) ^ ((p512_18 << 19) | (p512_18 >> 45)) ^ ((p512_18 << 53) | (p512_18 >> 11))) + m_state[3];
                uint64 p512_19 = (p512_00 + t512_21 - p512_10 + p512_13);
                p512_19 = ((p512_19 >> 2) ^ (p512_19 << 2) ^ ((p512_19 << 28) | (p512_19 >> 36)) ^ ((p512_19 << 59) | (p512_19 >> 5))) + m_state[4];
                uint64 p512_20 = (t512_16 + p512_02 + p512_09 - p512_11);
                p512_20 = ((p512_20 >> 1) ^ p512_20) + m_state[5];
                uint64 p512_21 = (p512_03 - p512_02 + p512_10 + t512_17);
                p512_21 = ((p512_21 >> 1) ^ (p512_21 << 3) ^ ((p512_21 << 4) | (p512_21 >> 60)) ^ ((p512_21 << 37) | (p512_21 >> 27))) + m_state[6];
                uint64 p512_22 = (p512_04 - p512_00 - p512_03 - p512_11 + p512_13);
                p512_22 = ((p512_22 >> 1) ^ (p512_22 << 2) ^ ((p512_22 << 13) | (p512_22 >> 51)) ^ ((p512_22 << 43) | (p512_22 >> 21))) + m_state[7];
                uint64 p512_23 = (t512_16 - p512_04 - p512_05 - p512_12);
                p512_23 = ((p512_23 >> 2) ^ (p512_23 << 1) ^ ((p512_23 << 19) | (p512_23 >> 45)) ^ ((p512_23 << 53) | (p512_23 >> 11))) + m_state[8];
                uint64 p512_24 = (p512_02 - p512_05 + t512_19 - p512_15);
                p512_24 = ((p512_24 >> 2) ^ (p512_24 << 2) ^ ((p512_24 << 28) | (p512_24 >> 36)) ^ ((p512_24 << 59) | (p512_24 >> 5))) + m_state[9];
                uint64 p512_25 = (p512_00 - p512_03 + p512_06 + t512_18);
                p512_25 = ((p512_25 >> 1) ^ p512_25) + m_state[10];
                uint64 p512_26 = (t512_21 - p512_04 - p512_07 + p512_15);
                p512_26 = ((p512_26 >> 1) ^ (p512_26 << 3) ^ ((p512_26 << 4) | (p512_26 >> 60)) ^ ((p512_26 << 37) | (p512_26 >> 27))) + m_state[11];
                uint64 p512_27 = (t512_20 - p512_00 - p512_02 + p512_09);
                p512_27 = ((p512_27 >> 1) ^ (p512_27 << 2) ^ ((p512_27 << 13) | (p512_27 >> 51)) ^ ((p512_27 << 43) | (p512_27 >> 21))) + m_state[12];
                uint64 p512_28 = (p512_01 + p512_03 - p512_06 - p512_09 + p512_10);
                p512_28 = ((p512_28 >> 2) ^ (p512_28 << 1) ^ ((p512_28 << 19) | (p512_28 >> 45)) ^ ((p512_28 << 53) | (p512_28 >> 11))) + m_state[13];
                uint64 p512_29 = (p512_02 + p512_04 + p512_07 + p512_10 + p512_11);
                p512_29 = ((p512_29 >> 2) ^ (p512_29 << 2) ^ ((p512_29 << 28) | (p512_29 >> 36)) ^ ((p512_29 << 59) | (p512_29 >> 5))) + m_state[14];
                uint64 p512_30 = (p512_03 + t512_20 - p512_11 - p512_12);
                p512_14 = ((p512_30 >> 1) ^ p512_30) + m_state[15];
                uint64 p512_31 = (p512_12 - p512_04 + t512_19 - p512_09);
                ...
                XL64 ^= p512_17;
                uint64 TempEven64 = p512_14 + p512_12 + p512_10 + p512_08 + p512_06 + p512_04 + p512_02;
                uint64 TempOdd64 = p512_15 + p512_13 + p512_11 + p512_09 + p512_07 + p512_05 + p512_03;
            ...
            void FinalCompression()
            {
                uint64 p512_00 = m_state[0] ^ 0xaaaaaaaaaaaaaaa0;
                uint64 p512_01 = m_state[1] ^ 0xaaaaaaaaaaaaaaa1;
                uint64 p512_02 = m_state[2] ^ 0xaaaaaaaaaaaaaaa2;
                uint64 p512_03 = m_state[3] ^ 0xaaaaaaaaaaaaaaa3;
                uint64 p512_04 = m_state[4] ^ 0xaaaaaaaaaaaaaaa4;
                uint64 p512_05 = m_state[5] ^ 0xaaaaaaaaaaaaaaa5;
                uint64 p512_06 = m_state[6] ^ 0xaaaaaaaaaaaaaaa6;
                uint64 p512_07 = m_state[7] ^ 0xaaaaaaaaaaaaaaa7;
                uint64 p512_08 = m_state[8] ^ 0xaaaaaaaaaaaaaaa8;
                uint64 p512_09 = m_state[9] ^ 0xaaaaaaaaaaaaaaa9;
                uint64 p512_10 = m_state[10] ^ 0xaaaaaaaaaaaaaaaa;
                uint64 p512_11 = m_state[11] ^ 0xaaaaaaaaaaaaaaab;
                uint64 p512_12 = m_state[12] ^ 0xaaaaaaaaaaaaaaac;
                uint64 p512_13 = m_state[13] ^ 0xaaaaaaaaaaaaaaad;
                uint64 p512_14 = m_state[14] ^ 0xaaaaaaaaaaaaaaae;
                uint64 p512_15 = m_state[15] ^ 0xaaaaaaaaaaaaaaaf;
        
                uint64 td64_00 = (m_state[0] << 1) | (m_state[0] >> 63);
                uint64 td64_01 = (m_state[1] << 2) | (m_state[1] >> 62);
                uint64 td64_02 = (m_state[2] << 3) | (m_state[2] >> 61);
                uint64 td64_03 = (m_state[3] << 4) | (m_state[3] >> 60);
                uint64 td64_04 = (m_state[4] << 5) | (m_state[4] >> 59);
                uint64 td64_05 = (m_state[5] << 6) | (m_state[5] >> 58);
                uint64 td64_06 = (m_state[6] << 7) | (m_state[6] >> 57);
                uint64 td64_07 = (m_state[7] << 8) | (m_state[7] >> 56);
                uint64 td64_08 = (m_state[8] << 9) | (m_state[8] >> 55);
                uint64 td64_09 = (m_state[9] << 10) | (m_state[9] >> 54);
                uint64 td64_10 = (m_state[10] << 11) | (m_state[10] >> 53);
                uint64 td64_11 = (m_state[11] << 12) | (m_state[11] >> 52);
                uint64 td64_12 = (m_state[12] << 13) | (m_state[12] >> 51);
                uint64 td64_13 = (m_state[13] << 14) | (m_state[13] >> 50);
                uint64 td64_14 = (m_state[14] << 15) | (m_state[14] >> 49);
                uint64 td64_15 = (m_state[15] << 16) | (m_state[15] >> 48);
            ...
            virtual array<byte>^ GetResult() OVERRIDE
            {
                ...
                array<byte>^ state = Converters::ConvertULongsToBytes(m_state);
