...
namespace Keccak
{
    ref class Keccak
    {
        ...
        private: void TransformBlock(array<byte>^ a_data, int a_index)
        {
            ...
            array<uint64>^ data = gcnew array<uint64>(25);
        ...
        private: void Finish()
        {
            array<byte>^ pad = gcnew array<byte>(147);
        ...
        private: array<byte>^ GetResult()
        {
            ...
            return ArrayExtensions::SubArray(state, 0, HashSize);
        }
