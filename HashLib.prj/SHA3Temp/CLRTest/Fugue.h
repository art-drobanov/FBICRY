...
namespace Fugue
{
    ...
    ref class Fugue256Base abstract : public FugueBase
    {
        protected:
            ...
            static array<uint64>^ aes_style_table0 = 
            {
            ...
            static array<uint64>^ aes_style_table1 = 
            {
            ...
            static array<uint64>^ aes_style_table2 = 
            {
            ...
            static array<uint64>^ aes_style_table3 = 
            {
            ...
            {
                uint64 row0, row1, row2, row3;
                uint64 col0, col1, col2, col3;
                uint64 tmp;
                uint tmp_zero;
                uint64 col_0,col_1,col_2,col_3,col_02,col_13;
                ...
                for (int j=0; j<5; j++) 
                {
                    ...
                    row3 ^= tmp;
                    col2 ^= tmp;
                    col_0 = (uint)col0^((uint64)col2<<32);
                    col_1 = (uint)col1^((uint64)col3<<32);
                    col_2 = (uint)col2^((uint64)col0<<32);
                    col_3 = (uint)col3^((uint64)col1<<32);
            ...
            virtual void TransformBlocks(array<byte>^ a_data, int a_index, int a_length) override
            {
                ...
                {
                    tmp_in = data32[j] | (uint64)data32[j+1] << 32;
