...
namespace HashLibTest
{
	...
	public class ConvertersTest
	{
		...
		public void ConvertersTest_All()
		{
			var ar1 = new byte[]
			          	{
			          		12, 234, 35, 167, 5, 66, 255, 23, 9, 10, 200, 12, 100,
...

			{
				...
				Assert.AreEqual(2, Converters.ConvertCharsToBytes(new[] {'d'}).Length);
				Assert.AreEqual(1, Converters.ConvertCharsToBytes(new[] {'d'}, Encoding.ASCII).Length);
				...
				Assert.AreEqual(4, Converters.ConvertIntsToBytes(new[] {0}).Length);
				Assert.AreEqual(4, Converters.ConvertIntsToBytes(new[] {0}, 0, 1).Length);
				Assert.AreEqual(4, Converters.ConvertIntsToBytesSwapOrder(new[] {0}).Length);
				Assert.AreEqual(4, Converters.ConvertIntsToBytesSwapOrder(new[] {0}, 0, 1).Length);
...

			{
...

				{
					...
					var ar2 = new ulong[ar1.Length / 8];
...

			{
				...
				CollectionAssert.AreEqual(new[]
				                          	{
				                          		(char)59916, (char)42787, (char)16901, (char)6143, (char)2569,
				                          		(char)3272, (char)38500, (char)4276, (char)9261, (char)20213, (char)14413, (char)42988
				                          	},
				                          Converters.ConvertBytesToChars(ar1));

				CollectionAssert.AreEqual(new[] {4.2819596702736908E-193, 3.3947371345724108E-228, -2.2381418769276721E-116},
				                          Converters.ConvertBytesToDoubles(ar1));

				CollectionAssert.AreEqual(new[] {-2.0f, 0.00310765952f, -3.689349E+19f, 50.8261681f},
				                          Converters.ConvertBytesToFloats(new byte[] {0, 0, 0, 192, 224, 169, 75, 59, 0, 0, 0, 224, 255, 77, 75, 66}));

				{
					CollectionAssert.AreEqual(new[] {-1490818548, 402604549, 214436361, 280270436, 1324688429, -1477691315},
					                          Converters.ConvertBytesToInts(ar1));

					var ar2 = new int[ar1.Length / 4];
					Converters.ConvertBytesToInts(ar1, ar2);
					CollectionAssert.AreEqual(new[] {-1490818548, 402604549, 214436361, 280270436, 1324688429, -1477691315}, ar2);

					CollectionAssert.AreEqual(new[] {1107666723, 168368127},
					                          Converters.ConvertBytesToInts(ar1, 2, 8));

					var ar3 = new int[2];
					Converters.ConvertBytesToInts(ar1, 2, 8, ar3);
					CollectionAssert.AreEqual(new[] {1107666723, 168368127}, ar3);

					var ar4 = new int[4];
					Converters.ConvertBytesToInts(ar1, 2, 8, ar4, 2);
					CollectionAssert.AreEqual(new[] {0, 0, 1107666723, 168368127}, ar4);
				}

				{
					CollectionAssert.AreEqual(new[] {216671143, 88276759, 151701516, 1687598096, 757396814, 1295576231},
					                          Converters.ConvertBytesToIntsSwapOrder(ar1));

					var ar2 = new int[ar1.Length / 4];
					Converters.ConvertBytesToIntsSwapOrder(ar1, ar2);
					CollectionAssert.AreEqual(new[] {216671143, 88276759, 151701516, 1687598096, 757396814, 1295576231}, ar2);

					CollectionAssert.AreEqual(new[] {598148418, -15267574},
					                          Converters.ConvertBytesToIntsSwapOrder(ar1, 2, 8));

					var ar3 = new int[2];
					Converters.ConvertBytesToIntsSwapOrder(ar1, 2, 8, ar3);
					CollectionAssert.AreEqual(new[] {598148418, -15267574}, ar3);

					var ar4 = new int[4];
					Converters.ConvertBytesToIntsSwapOrder(ar1, 2, 8, ar4, 2);
					CollectionAssert.AreEqual(new[] {0, 0, 598148418, -15267574}, ar4);
				}

				{
					CollectionAssert.AreEqual(new[] {1729173373979978252, 1203752356870097417, -6346635870183545811},
					                          Converters.ConvertBytesToLongs(ar1));

					var ar2 = new long[ar1.Length / 8];
					Converters.ConvertBytesToLongs(ar1, ar2);
					CollectionAssert.AreEqual(new[] {1729173373979978252, 1203752356870097417, -6346635870183545811}, ar2);

					CollectionAssert.AreEqual(new[] {723135600261441315, 2606758127120682184},
					                          Converters.ConvertBytesToLongs(ar1, 2, 16));

					var ar3 = new long[2];
					Converters.ConvertBytesToLongs(ar1, 2, 16, ar3);
					CollectionAssert.AreEqual(new[] {723135600261441315, 2606758127120682184}, ar3);

					var ar4 = new long[4];
					Converters.ConvertBytesToLongs(ar1, 2, 16, ar4, 2);
					CollectionAssert.AreEqual(new[] {0, 0, 723135600261441315, 2606758127120682184}, ar4);
				}

				{
					CollectionAssert.AreEqual(new[] {930595473260216087, 651553051661218832, 3252994547520171175},
					                          Converters.ConvertBytesToLongsSwapOrder(ar1));

					var ar2 = new long[ar1.Length / 8];
					Converters.ConvertBytesToLongsSwapOrder(ar1, ar2);
					CollectionAssert.AreEqual(new[] {930595473260216087, 651553051661218832, 3252994547520171175}, ar2);

					CollectionAssert.AreEqual(new[] {2569027897743837450, -4031736967974605532},
					                          Converters.ConvertBytesToLongsSwapOrder(ar1, 2, 16));

					var ar3 = new long[2];
					Converters.ConvertBytesToLongsSwapOrder(ar1, 2, 16, ar3);
					CollectionAssert.AreEqual(new[] {2569027897743837450, -4031736967974605532}, ar3);

					var ar4 = new long[4];
					Converters.ConvertBytesToLongsSwapOrder(ar1, 2, 16, ar4, 2);
					CollectionAssert.AreEqual(new[] {0, 0, 2569027897743837450, -4031736967974605532}, ar4);
				}
...

			{
				...
				var ms1 = new MersenneTwister(5687);
				var ms2 = new MersenneTwister(5687);

				CollectionAssert.AreEqual(new[] {ms1.NextByte()}, Converters.ConvertToBytes(ms2.NextByte()));
