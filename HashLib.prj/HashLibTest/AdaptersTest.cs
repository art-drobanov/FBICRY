        ...
        {
            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    Assert.IsFalse(!md5.ComputeBytes(v.Take(1).ToArray()).GetBytes().SequenceEqual(md5.ComputeByte((byte)v[0]).GetBytes()));
...

            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    Assert.IsFalse(murmur2.ComputeBytes(v.Take(1).ToArray()) != murmur2.ComputeByte((byte)v[0]));
...

            {
                ...
                MersenneTwister ms1 = new MersenneTwister(5566);
                MersenneTwister ms2 = new MersenneTwister(5566);
