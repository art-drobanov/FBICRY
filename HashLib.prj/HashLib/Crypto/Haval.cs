...
namespace HashLib.Crypto
{
	...
	abstract class Haval : HashCryptoNotBuildIn
	{
		...
		protected override void Finish()
		{
			...
			pad[padindex++] = (byte)(((m_rounds & 0x07) << 3) | (HAVAL_VERSION & 0x07));
		...
		private void TailorDigestBits()
		{
			...
			switch(HashSize)
			{
				case 16:
					...
					break;
				case 20:
					t = (m_hash[7] & 0x3F) | (uint)(m_hash[6] & (0x7F << 25)) | (m_hash[5] & (0x3F << 19));
					m_hash[0] += t >> 19 | t << 13;
					t = (m_hash[7] & (0x3F << 6)) | (m_hash[6] & 0x3F) | (uint)(m_hash[5] & (0x7F << 25));
					m_hash[1] += t >> 25 | t << 7;
					t = (m_hash[7] & (0x7F << 12)) | (m_hash[6] & (0x3F << 6)) | (m_hash[5] & 0x3F);
					m_hash[2] += t;
					t = (m_hash[7] & (0x3F << 19)) | (m_hash[6] & (0x7F << 12)) | (m_hash[5] & (0x3F << 6));
					m_hash[3] += (t >> 6);
					t = (m_hash[7] & ((uint)0x7F << 25)) | (m_hash[6] & (0x3F << 19)) | (m_hash[5] & (0x7F << 12));
					m_hash[4] += (t >> 12);
					break;
				case 24:
					t = (m_hash[7] & 0x1F) | (uint)(m_hash[6] & (0x3F << 26));
					m_hash[0] += t >> 26 | t << 6;
					...
					m_hash[4] += (t >> 16);
					t = (uint)(m_hash[7] & (0x3F << 26)) | (m_hash[6] & (0x1F << 21));
					m_hash[5] += (t >> 21);
					break;
				case 28:
	...
	abstract class Haval3 : Haval
	{
		...
		protected override void TransformBlock(byte[] a_data, int a_index)
		{
			...
			Converters.ConvertBytesToUInts(a_data, a_index, BlockSize, temp);
	...
	abstract class Haval4 : Haval
	{
		...
		private void TransformBlockRounds5(byte[] a_data, int a_index)
		{
			...
			Debug.Assert(a_index + BlockSize <= a_data.Length);
