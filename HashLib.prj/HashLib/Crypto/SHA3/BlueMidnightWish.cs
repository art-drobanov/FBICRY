...
{
	class BlueMidnightWish224 : BlueMidnightWish256Base
	{
	...
	class BlueMidnightWish256 : BlueMidnightWish256Base
	{
	...
	class BlueMidnightWish384 : BlueMidnightWish512Base
	{
	...
	class BlueMidnightWish512 : BlueMidnightWish512Base
	{
	...
	abstract class BlueMidnightWishBase : HashCryptoNotBuildIn
	{
		...
		protected override void Finish()
		{
			...
			int index = BlockSize - m_buffer.Pos - 8;

			if(m_buffer.Pos >= BlockSize - 8)
				index += BlockSize;

			var pad = new byte[index + 8];
	...
	abstract class BlueMidnightWish256Base : BlueMidnightWishBase
	{
		#region Consts
		...
		protected override void TransformBlock(byte[] a_data, int a_index)
		{
			...
			Converters.ConvertBytesToUInts(a_data, a_index, 64, data);
	...
	abstract class BlueMidnightWish512Base : BlueMidnightWishBase
	{
		#region Consts
		...
		protected override void TransformBlock(byte[] a_data, int a_index)
		{
			var data = new ulong[16];
			Converters.ConvertBytesToULongs(a_data, a_index, 128, data);
