...
namespace HashLib.Crypto.SHA3
{
	...
	abstract class EchoBase : HashCryptoNotBuildIn
	{
		#region Consts
		...
		protected override void Finish()
		{
			...
			if((BlockSize - m_buffer.Pos) <= 18)
			{
				...
				m_processedBytes -= (ulong)pad_len;
	...
	abstract class Echo256Base : EchoBase
	{
	...
	abstract class Echo512Base : EchoBase
	{
