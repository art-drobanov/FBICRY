...
namespace HashLib.Crypto.SHA3
{
    ...
    internal class CubeHash_1_8_512 : CubeHashCustom
    {
    ...
    internal class CubeHash_1_1_512 : CubeHashCustom
    {
    ...
    internal class CubeHash_8_1_512 : CubeHashCustom
    {
    ...
    internal class CubeHash_8_64_512 : CubeHashCustom
    {
    ...
    internal class CubeHashCustom : CubeHash
    {
        public CubeHashCustom(HashLib.HashSize a_hashSize, int a_rounds = 16, int a_blockSize = 32)
            : base(a_hashSize, a_rounds, a_blockSize)
        {
        }
    }

    internal abstract class CubeHash : HashCryptoNotBuildIn
    {
        ...
        static CubeHash()
        {
            ...
            int[] rounds = new int[] { 1, 2, 4, 8, 16 };
            int[] blocksizes = new int[] { 1, 2, 4, 8, 16, 32, 64, 128 };
            uint[, ,][] inits = new uint[rounds.Last() + 1, hashes.Last() + 1, blocksizes.Last() + 1][];
            byte[] zeroes = new byte[blocksizes.Last()];
        ...
        public CubeHash(HashLib.HashSize a_hashSize, int a_rounds = 16, int a_blockSize = 32)
