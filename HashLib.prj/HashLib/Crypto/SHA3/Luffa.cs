...
{
    internal abstract class LuffaBase : HashCryptoNotBuildIn
    {
        #region Consts
        ...
        public LuffaBase(HashLib.HashSize a_hashSize)
    ...
    {
        public Luffa256Base(HashLib.HashSize a_hashSize)
            : base(a_hashSize)
        {
            m_result_blocks = 3;
            m_iv_length = 24;
        ...
        protected override void TransformBlock(byte[] a_data, int a_index)
        {
            ...
            t0 = m_state[0] ^ m_state[0 + 8] ^ m_state[0 + 16];
            t1 = m_state[1] ^ m_state[1 + 8] ^ m_state[1 + 16];
            t2 = m_state[2] ^ m_state[2 + 8] ^ m_state[2 + 16];
            t3 = m_state[3] ^ m_state[3 + 8] ^ m_state[3 + 16];
            t4 = m_state[4] ^ m_state[4 + 8] ^ m_state[4 + 16];
            t5 = m_state[5] ^ m_state[5 + 8] ^ m_state[5 + 16];
            t6 = m_state[6] ^ m_state[6 + 8] ^ m_state[6 + 16];
            t7 = m_state[7] ^ m_state[7 + 8] ^ m_state[7 + 16];
