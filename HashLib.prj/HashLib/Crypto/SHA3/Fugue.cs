...
{
	abstract class FugueBase : HashCryptoNotBuildIn
	{
		...
		protected override void Finish()
		{
			...
			int padindex = 4 - (int)(m_processedBytes % 4);
	...
	abstract class Fugue256Base : FugueBase
	{
		#region Consts
	...
	abstract class Fugue512Base : FugueBase
	{
		#region Consts
